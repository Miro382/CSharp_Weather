...
namespace CSharp_Weather
{
    public class WeatherMET
    {
        ...
        public bool GetWeatherData(float latitude, float longtitude)
        {
            try
            {
                string xml = HelpClass.GETHtml("http://api.met.no/weatherapi/locationforecastlts/1.2/?lat=" + latitude + ";lon=" + longtitude);
        ...
        public Bitmap GetIcon(int night)
        {
            ...
            System.Net.WebRequest.Create("http://api.met.no/weatherapi/weathericon/1.1/?symbol=" + weatherinfo.Symbolnumber + ";is_night=" + night + ";content_type=image/png");
